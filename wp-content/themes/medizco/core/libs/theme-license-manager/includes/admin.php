    ...
    public function add_menu_page() {
        ...
        <div class="license-wrap">
            <?php if ( theme_is_valid_license() ): ?>
                <div class="license-content">
                    <h2 class="license-title">
                        <?php esc_html_e( 'Your license is activated', 'medizco' ); ?>
                    </h2>
                    <div class="license-instruction">
                        <ul class="license-link">
                            <li>
                                <?php echo esc_html__("Install and active all the require plugin follow the Medizco official documentation", "medizco");?> 
                            </li>
                        </ul>
                    </div>
                ...
                <form action="" method="POST">
                    <input 
                        ...
                        placeholder="<?php esc_attr_e( 'Enter your name', 'medizco' ); ?>" required
                    >
                    <input 
                        type="hidden" 
                        id="email" 
                        ...
                        placeholder="<?php esc_attr_e( 'Enter your email', 'medizco' ); ?>" required
                    >
                    <input 
                        type="hidden" 
                        id="license_key" 
                        class="regular-text" 
                        name="license_key" 
                        placeholder="<?php esc_attr_e( 'Enter your license key', 'medizco' ); ?>"
                        value="<?php echo esc_attr( $license_key ); ?>"
                        required
                    >
                    <?php 
                        wp_nonce_field( 'theme_license_activation', 'theme_license_activation_nonce' );
                        submit_button( __('Deactivate License', 'medizco'), 'delete button-primary', 'theme-deactive' ); 
                    ?>
                </form>
                
            <?php else: ?>
            <div class="license-content">
                <h2 class="license-title"><?php esc_html_e( 'License Activation', 'medizco' ); ?></h2>
                <div class="license-instruction">
                    <ul class="license-link">
                        <li><?php echo esc_html__("Log into your Envato Market account ", "medizco"); ?></li>
                        <li><?php echo esc_html__( "Hover the mouse over your username at the top of the screen.", "medizco" ); ?></li>
                        <li><?php echo esc_html__("Click 'Downloads' from the drop-down menu.", "medizco");?></li>
                        <li><?php echo esc_html__("Click 'License certificate & purchase code' (available as PDF or text file) See the ", "medizco");?> 
                            <a href="https://youtu.be/srghr25uBgc" target="_blank"><br><?php echo esc_html__("Video Documentation", "medizco"); ?></a>
                            <?php echo esc_html__("for details ", "medizco");?> 
                        </li>
                    </ul>
                </div>
                <div class="license-desc">
                    ...
                    <p>
                        <?php esc_html_e( 'In order to get the regular updates, support, demo content & customizer option you must activate the theme license.', 'medizco' ); ?>
                    </p>
                </div>
            </div>
            ...
            <form action="" method="POST">
                ...
                <?php 
                    submit_button( __('Activate License', 'medizco') );
                ?>
            </form>
            <?php endif; ?>
        </div>
