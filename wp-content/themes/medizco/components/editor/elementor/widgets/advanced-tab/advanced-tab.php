        ...
        <div class="elementkit-tab-wraper <?php echo esc_attr($ekit_tab_style == 'vertical' ? 'vertical' : ''); ?> <?php if ($ekit_tab_fill_full_width != 'yes') : ?> elementskit-fitcontent-tab <?php endif; ?>">
            <ul class="<?php echo esc_attr($nav_wrapper_class); ?>" role="tablist">
                <?php foreach ($ekit_tab_items as $i=>$tab) :
                    ...
                    $img_html_src = wp_get_attachment_image($tab['ekit_tab_title_image']['id'], array(50, 50), false, array(
                        'draggable' => 'false'
                    ));

                    if( ( isset($tab['ekit_tab_title_icon_type']) ) && ( $tab['ekit_tab_title_icon_type'] == 'image' ) &&  ( !empty( $tab['ekit_tab_title_image']['url']) ) ) {
                        $img_html = '<div class="ekit-icon-image">'.$img_html_src.'</div>';
                    }
                    else {
                        $img_html = '';
                    }
                    ...
                    <div class="tab-pane elementkit-tab-pane elementor-repeater-item-<?php echo esc_attr( $tab[ '_id' ] ); ?> <?php echo esc_attr($is_active);?>" id="content-<?php echo esc_attr($tab['_id'].$tab_id); ?>" role="tabpanel"
                        ...
                        <div class="animated fadeIn">
                            ...
                            <figure>
                                ...
                                <?php 
                                    echo wp_get_attachment_image($tab['ekit_tab_content_image']['id'], 'full', false, array(
                                        'alt'   =>  esc_attr__('Tab image', 'medizco')
                                    ));  
                                ?>
