    ...
    public static function chart_dataset($settings) {
        ...
        if (!empty($items)) {
            foreach ($items as $item) {
                ...
                $item['hoverBackgroundColor'] = !empty($item['hover_background_color']) ? $item['hover_background_color'] : '#8441A4';
                $item['hoverBorderColor']     = !empty($item['hover_border_color']) ? $item['hover_border_color'] : '#E0528D';
