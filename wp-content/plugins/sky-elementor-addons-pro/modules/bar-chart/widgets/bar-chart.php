...
namespace Sky_Addons_Pro\Modules\BarChart\Widgets;

use Elementor\Controls_Manager;
use Elementor\Repeater;
use Elementor\Widget_Base;

use Sky_Addons_Pro\Modules\BarChart\Chart_Map;
use Sky_Addons_Pro\Traits\Global_Chart;

if (!defined('ABSPATH'))
    exit; // Exit if accessed directly

class Bar_Chart extends Widget_Base {

    use Global_Chart;

    public function get_name() {
        return 'sky-bar-chart';
    }

    public function get_title() {
        return esc_html__('Bar Chart', 'sky-elementor-addons-pro');
    }

    public function get_icon() {
        return 'sky-icon-bar-chart';
    }
    ...
    public function get_keywords() {
        return ['bar', 'chart', 'graph', 'business', 'sky'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Bar Chart', 'sky-elementor-addons-pro'),
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'     => ['active' => true],
                'label_block' => true,
                'default'     => esc_html__('January, February, March', 'sky-elementor-addons-pro'),
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'data'                   => esc_html__('1, 3, 5', 'sky-elementor-addons-pro'),
                        'background_color'       => 'rgba(132, 65, 164, 0.8)',
                        'hover_background_color' => '#8441A4',
                        'border_color'           => '#8441A4',
                        'hover_border_color'     => '#8441A4',
                    ],
                    [
                        'label'                  => esc_html__('Sky Addons Pro', 'sky-elementor-addons-pro'),
                        'data'                   => esc_html__('2, 4, 6', 'sky-elementor-addons-pro'),
                        'background_color'       => 'rgba(224, 82, 141, 0.8)',
                        'hover_background_color' => '#E0528D',
                        'border_color'           => '#E0528D',
                        'hover_border_color'     => '#E0528D',
                    ]
                ],
                'title_field' => '{{{ label }}}',
            ]
    ...
    protected function render() {
        include_once SKY_ADDONS_PRO_MODULES_PATH . 'bar-chart/class/chart-map.php';
        ...
        $this->add_render_attribute(
            ...
            [
                'id'                   => $id,
                'class'                => 'sa-bar-chart sa-global-chart',
