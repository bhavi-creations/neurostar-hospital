...
namespace Sky_Addons_Pro\Modules\RadarChart\Widgets;

use Elementor\Controls_Manager;
use Elementor\Repeater;
use Elementor\Widget_Base;

use Sky_Addons_Pro\Modules\RadarChart\Chart_Map;
...
class Radar_Chart extends Widget_Base {
    ...
    public function get_name() {
        return 'sky-radar-chart';
    }

    public function get_title() {
        return esc_html__('Radar Chart', 'sky-elementor-addons-pro');
    }

    public function get_icon() {
        return 'sky-icon-radar-chart';
    }
    ...
    public function get_keywords() {
        return ['radar', 'chart', 'graph', 'business', 'sky'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Radar Chart', 'sky-elementor-addons-pro'),
        ...
        $this->add_control(
            'chart_type',
            [
                'label'   => esc_html__('Type', 'sky-elementor-addons-pro'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'bar',
                'options' => [
                    'bar'            => esc_html__('Vertical', 'sky-elementor-addons-pro'),
                    'bar_horizontal' => esc_html__('Horozontal', 'sky-elementor-addons-pro'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic'     => ['active' => true],
                'label_block' => true,
                'default'     => esc_html__('January, February, March, April, May, June, July', 'sky-elementor-addons-pro'),
        ...
        $repeater->add_control(
            'point_border_color',
            [
                'label' => __('Point Border Color', 'sky-elementor-addons-pro'),
                'type'  => Controls_Manager::COLOR,
                'separator' => 'before'
            ]
        );
        ...
        $repeater->add_control(
            'point_border_color_hover',
            [
                'label' => __('Hover Point Border Color', 'sky-elementor-addons-pro'),
                'type'  => Controls_Manager::COLOR,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__('Point Background Color', 'sky-elementor-addons-pro'),
                'type'  => Controls_Manager::COLOR,
            ]
        );
        $repeater->add_control(
            'point_background_color_hover',
            [
                'label' => esc_html__('Hover Point Background Color', 'sky-elementor-addons-pro'),
                'type'  => Controls_Manager::COLOR,
            ]
        );
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'data'               => esc_html__('65, 59, 90, 81, 56, 55, 40', 'sky-elementor-addons-pro'),
                        'background_color'   => 'rgba(132, 65, 164, 0.15)',
                        'border_color'       => '#8441A4',
                        'point_border_color' => '#8441A4',
                    ],
                    [
                        'label'              => esc_html__('Sky Addons Pro', 'sky-elementor-addons-pro'),
                        'data'               => esc_html__('28, 48, 40, 19, 96, 27, 100', 'sky-elementor-addons-pro'),
                        'background_color'   => 'rgba(224, 82, 141, 0.15)',
                        'border_color'       => '#E0528D',
                        'point_border_color' => '#E0528D',
                    ]
                ],
                'title_field' => '{{{ label }}}',
            ]
        ...
        $this->add_control(
            ...
            [
                'label'      => esc_html__('Pointer Border Width', 'sky-elementor-addons-pro'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
        ...
        $this->add_control(
            'angle_lines_color',
            [
                'label'     => esc_html__('Angle Lines Color', 'sky-elementor-addons-pro'),
                'type'      => Controls_Manager::COLOR,
            ]
        );
        ...
        $this->start_controls_section(
            'style_point_labels',
            [
                'label'     => esc_html__('Point Labels', 'sky-elementor-addons-pro'),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_control(
            'point_labels_font_color',
            [
                'label' => esc_html__('Text Color', 'sky-elementor-addons-pro'),
                'type'  => Controls_Manager::COLOR,
            ]
        ...
        $this->global_chart_typo_controls('point_labels');
    ...
    protected function render() {
        include_once SKY_ADDONS_PRO_MODULES_PATH . 'radar-chart/class/chart-map.php';
        ...
        $this->add_render_attribute(
            ...
            [
                'id'                   => $id,
                'class'                => 'sa-radar-chart sa-global-chart',
