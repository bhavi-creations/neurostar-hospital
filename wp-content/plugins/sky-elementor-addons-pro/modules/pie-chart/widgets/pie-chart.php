...
namespace Sky_Addons_Pro\Modules\PieChart\Widgets;

use Elementor\Controls_Manager;
use Elementor\Repeater;
use Elementor\Widget_Base;

use Sky_Addons_Pro\Modules\PieChart\Chart_Map;
...
class Pie_Chart extends Widget_Base {
    ...
    public function get_name() {
        return 'sky-pie-chart';
    }

    public function get_title() {
        return esc_html__('Pie & Doughnut Chart', 'sky-elementor-addons-pro');
    }

    public function get_icon() {
        return 'sky-icon-pie-chart';
    }
    ...
    public function get_keywords() {
        return ['pie', 'doughnut', 'chart', 'graph', 'business', 'sky'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Pie Area Chart', 'sky-elementor-addons-pro'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'pie',
                'options' => [
                    'pie'      => esc_html__('Pie', 'sky-elementor-addons-pro'),
                    'doughnut' => esc_html__('Doughnut', 'sky-elementor-addons-pro'),
                ],
            ]
        );
        ...
        $repeater->add_control(
            'hover_offset',
            [
                'label' => esc_html__('Hover Offset', 'sky-elementor-addons-pro'),
                'type'  => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'  => 0,
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'data'                   => '11',
                        'background_color'       => 'rgba(224, 82, 141, 0.9)',
                        'hover_background_color' => 'rgba(224, 82, 141, 1)',
                    ],
                    [
                        'label'                  => esc_html__('Green', 'sky-elementor-addons-pro'),
                        'data'                   => '16',
                        'background_color'       => 'rgba(75, 192, 192, 0.9)',
                        'hover_background_color' => 'rgba(75, 192, 192, 1)',
                    ],
                    [
                        'label'                  => esc_html__('Yellow', 'sky-elementor-addons-pro'),
                        'data'                   => '7',
                        'background_color'       => 'rgba(255, 205, 86, 0.9)',
                        'hover_background_color' => 'rgba(255, 205, 86, 1)',
                    ],
                    [
                        'label'                  => esc_html__('Grey', 'sky-elementor-addons-pro'),
                        'data'                   => '3',
                        'background_color'       => 'rgba(201, 203, 207, 0.9)',
                        'hover_background_color' => 'rgba(201, 203, 207, 1)',
                    ],
                    [
                        'label'                  => esc_html__('Blue', 'sky-elementor-addons-pro'),
                        'data'                   => '14',
                        'background_color'       => 'rgba(54, 162, 235, 0.9)',
                        'hover_background_color' => 'rgba(54, 162, 235, 1)',
                    ],
                ],
                'title_field' => '{{{ label }}}',
            ]
    ...
    protected function render() {
        include_once SKY_ADDONS_PRO_MODULES_PATH . 'pie-chart/class/chart-map.php';
        ...
        $this->add_render_attribute(
            ...
            [
                'id'                   => $id,
                'class'                => 'sa-pie-chart sa-global-chart',
