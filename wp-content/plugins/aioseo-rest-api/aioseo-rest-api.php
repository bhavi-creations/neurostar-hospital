...
new AIOSEOExtend( 'AIOSEO - REST API', 'aioseo_rest_api_load', AIOSEO_REST_API_FILE, '4.3.6' );
...
function aioseo_rest_api_load() {
	...
	$extend = new AIOSEOExtend( 'AIOSEO - REST API', '', AIOSEO_REST_API_FILE, '4.3.6', $levels );
